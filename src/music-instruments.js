...
export const INSTRUMENTS = [
 ...
 {id:'kit',name:'Ударная установка',icon:'🥁',type:'kit',notes:[65,180,7000,4500,140,220,95,6500,3800,600,4200],labels:['Бочка','Малый','Хэт закрытый','Крэш','Том 2 · средний','Том 1 · высокий','Том 3 · низкий','Хэт открытый','Чайна','Ковбэл','Райд'],presets:['Камерный джаз','Сухой фанк','Большая сцена']},
