...
Чайная карта: 20 предметных визуализаций сухого чая на чахэ в `public/tea/generated/` созданы встроенным imagegen специально для проекта. Это изображения типичного внешнего вида сухого листа, а не фотографии конкретных партий. Первоначальная фотография витрины владельца сохранена в `public/reference/photo-3985.jpg`; внешний фотобанк не использован. Тексты написаны для проекта, температурные ориентиры сверены с [TeaVivre](https://www.teavivre.com/info/common-gongfu-tea-brewing-mistakes-to-avoid.html) и [общим руководством по завариванию](https://www.teavivre.com/info/?p=17774). Общие профили не заменяют дегустацию конкретных партий.
