...
Дудук: выделены три устойчивых тона из записи ethnictune; удалён низкочастотный фон, измерена основная частота, подготовлены петли удержания с перекрытием 120 мс. Естественные дыхание и вибрато сохранены. Открытый хэт, ковбэл и райд — дополнительные записи Virtuosity Drums; низкий третий том воспроизводит запись тома в пониженном строе. Для щелчка пальцев и сухого края добавлены записи малого рамочного барабана VCSL. Двойные удары, флэм и роллы собираются из отдельных записей по аудиочасам.

Чайная карта: `public/tea/vitrine.jpg` — уменьшенная копия предоставленной владельцем фотографии IMG_3985. Отдельные упаковки показаны через окна в CSS; внешний фотобанк не использован. Тексты написаны для проекта, температурные ориентиры сверены с [TeaVivre](https://www.teavivre.com/info/common-gongfu-tea-brewing-mistakes-to-avoid.html) и [общим руководством по завариванию](https://www.teavivre.com/info/?p=17774). Общие профили не заменяют дегустацию конкретных партий.
